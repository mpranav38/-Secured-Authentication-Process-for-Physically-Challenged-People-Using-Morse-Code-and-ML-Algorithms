...
##    window.title("Mouse_Cursor")
##
##    def mouse_clicks_morse():
##        os.system("python mouse-clicks-morse.py")
def gaze():
    os.system("python gaze.py")
##
##    
##    Label(window, text="Select Your Choice", bg="gold", width="300", height="2", font=("Arial", 13)).pack()
##    #Label(text="").pack()
##    Button(window,text="gaze", height="2", width="30", command = gaze).pack()
##    #Label(text="").pack()
##    Button(window,text="mouse_clicks_morse", height="2", width="30", command=mouse_clicks_morse).pack()
##    window.mainloop()
